...
import LogoIcon from '@/assets/images/HeroBg.png'; // Your logo
  ...
  return (
    <header
      className={`fixed top-0 left-0 right-0 z-50 transition-all duration-500 ease-in-out ${
        scrolled
          ? 'bg-black/60 backdrop-blur-lg border-b border-white/10 shadow-md'
          : 'bg-transparent'
      }`}
    >
      <div className="flex items-center justify-between px-8 py-5">
        ...
        <Link href="/" className="flex items-center gap-3">
          <Image src={LogoIcon} alt="Logo" width={36} height={36} className="rounded-lg" />
          <span className="text-white text-lg font-semibold tracking-wide">bueno</span>
        </Link>
